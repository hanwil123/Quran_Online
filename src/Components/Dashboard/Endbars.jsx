...
const Endbars = () => {
  return (
    <>
      <aside class=" w-28 bg-[#bcdec3] min-h-full h-screen flex flex-col items-center pt-5 pb-2 space-y-7">
        <div class="w-full pr-3 flex flex-col gap-y-1 text-gray-500 fill-gray-500 text-sm">
          ...
          <div class="w-full flex items-center gap-x-1.5 group select-none bg-yellow-400">
            <div class="w-1 rounded-xl h-8 transition-colors duration-200 relative overflow-hidden">
